...
rasmusprip.factory('projekter', function(){
    ...
    var addItem = function(section, description){
        ...
        addItem("NBE V13 app", "V13 er en app designet til at agere som brugerinterface til af pillefyr fra NBE production A/S. Fra appen kan man ændre diverse drifts indstillinger, overvåge aktuelle driftdata, overvåge driftdata over tid i form af grafer og lignende. Appen er en klient som kommunikerer med fyrets styring over en protokol bygget på UDP, som er spcial designet til NBE prokukter http://market.android.com/details?id=com.google.earth");
    addItem("NBE Grill app", "Formålet med denne app er at kunne fjernstyre træpillegrillen produceret af NBE Production A/S. Endvidere kan man konfigurere grillens netværk og bruge enhedens muligheder for diverse notifikationer i forbindelse  med madlavningen. Ligesom NBE V13(Se ovenstående projekt besrivelse) er Grill appen en klient, som kommunikerer over en netværks protokol special designet til NBE produkter");
